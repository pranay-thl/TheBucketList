...
<html>
	...
	<div class="div1"><head><span style="float:left;"><a href="index.php"><i class="fa fa-arrow-left" style="font-size: 40px;color:#FFF;margin-left: 30px;"></i></a></span><?=$_GET['album_name']?></head></div>
	<body>
		<ul id="rig">
	<?php
